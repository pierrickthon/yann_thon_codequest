...
class RoadmapMap {
    ...
    generateMockProgress() {
        return {
            ...
            sceneDetails: {
                ...
                'N02-destructuring': { completed: false, unlocked: true }
            }
        };
    }
    ...
    setupNodes() {
        const nodePositions = [
            ...
            { id: 'N02-destructuring', x: 480, y: 370, title: 'Arrays & Objects', description: 'Data manipulation, functional programming' },
            ...
            { id: 'N06-tdd', x: 1100, y: 340, title: 'TDD Methodology', description: 'Red-Green-Refactor cycle' }
        ];
    ...
    getNodeState(sceneId) {
        ...
        if (completedScenes.includes(sceneId)) {
            ...
            const sceneOrder = ['N00-intro', 'N01-functions', 'N02-destructuring', 'N03-async', 'N04-error-handling', 'N05-testing', 'N06-tdd'];
